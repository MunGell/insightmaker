...
functionLoaders.push(function(){
	...
	defineFunction("PastMean", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
		if (x.length == 1) {
	...
	defineFunction("PastMedian", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
	...
	defineFunction("PastValues", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
	...
	defineFunction("PastStdDev", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
	...
	defineFunction("PastCorrelation", {params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "[Primitive]",  noVector: true, needPriobject: [functionBank, PrimitiveObject], mitive:true}, {name: "Past Range", noVector: true, defaultVal: "All Time"}]}, function(x) {
		var items1;
		var items2;
		if (x[2] != "All Time") {
	...
	defineFunction("PastMax", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
	...
	defineFunction("PastMin", {object: [functionBank, PrimitiveObject], params:[{name: "[Primitive]",  noVector: true, needPrimitive:true}, {name: "Past Range", defaultVal: "All Time", noVector: true}]}, function(x) {
	...
	defineFunction("Smooth", {object: [functionBank, PrimitiveObject], params: [{name: "[Primitive]",  noVector: true, needPrimitive: true}, {name: "Length",  noVector: true}, {name: "Initial Value",  noVector: true, defaultVal: "None"}]}, function(x) {
	...
	defineFunction("Delay", {object: [functionBank, PrimitiveObject], params: [{name: "[Primitive]",  noVector: true, needPrimitive: true}, {name: "Length",  noVector: true}, {name: "Initial Value",  noVector: true, defaultVal: "None"}]}, function(x) {
	...
	defineFunction("Delay1", {object: [functionBank, PrimitiveObject], params: [{name: "[Primitive]",  noVector: true, needPrimitive: true}, {name: "Length",  noVector: true}, {name: "Initial Value",  noVector: true, defaultVal: "None"}]}, function(x) {
	...
	defineFunction("Delay3", {object: [functionBank, PrimitiveObject], params: [{name: "[Primitive]",  noVector: true, needPrimitive: true}, {name: "Length",  noVector: true}, {name: "Initial Value",  noVector: true, defaultVal: "None"}]}, function(x) {
	...
	defineFunction("SetValue", {object: [functionBank, VectorObject, PrimitiveObject], params: [{name: "[Population]"}, {needPrimitive: true, name: "[Primitive]"}, {name: "Value", noVector: true, allowBoolean: true}]}, function(x) {//need population should be false
		var id = x[1].id;
	...
	defineFunction("FindNearby", {object: [functionBank, VectorObject, PrimitiveObject], params: [{needPopulation: true, name: "[Agent Population]"}, {needAgent: true, name: "[Agent]"}, {name: "Distance Limit", noVector:true}]}, function(x) {
		var population = x[0];
	...
	defineFunction("FindFurthest", {object: [functionBank, VectorObject, PrimitiveObject], params: [{needPopulation: true, name: "[Agent Population]"}, {needAgent: true, name: "[Agent]"}, {noUnits:true, noVector:true, defaultVal:1, name: "Count"}]}, function(x) {
	...
	defineFunction("Connect", {object: [functionBank, AgentObject], params: [{needAgent: true, name: "[Agent 1]"}, {name: "[Agent 2]"}]}, function(x) {
	...
	defineFunction("Distance", {object: [functionBank, AgentObject], params: [{name: "[Agent 1]"}, {name: "[Agent 2]"}]}, function(x) {
		if(! (x[0] instanceof Vector)){
			x[0] = agent(x[0]);
		}
		if(! ( x[1] instanceof Vector)){
	...
	defineFunction("Location", {object: [functionBank, AgentObject], params: [{needAgent: true, name: "[Primitive]"}]}, function(x) {
		return x[0].location;
	});
