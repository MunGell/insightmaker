			...
			Ext.create('Ext.ux.form.field.BoxSelect', {
				...
				listeners: {
					change: function(list, newData, oldData){
						...
						var oldItems = oldData.split?oldData.split(", "):[];
...
function optString(marker){
	...
	var s ="<br/><center><table border='1' cellpadding='4' align = 'center' style='text-align:center;background-color: #f8ffcf; border: solid 1px black;'><tr><td style='padding:.5em'><b>Primitive</b></td><td style='padding:.5em'><b>Optimum</b></td><td style='padding:.5em'><b>Range</b></td></tr><tr><td colspan=3 style='padding:.5em'><b>Goal Primitive</b></td></tr>";
